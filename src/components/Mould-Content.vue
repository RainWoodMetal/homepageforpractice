<template>
  <div :class="conLayout">
      ...
      <mould-layout :num="layoutNumber(layout)" :itemData="itemData" :itemIndex="itemIndex" :isSub="isSub"></mould-layout>
  </div>
</template>
...
import MouldLayout from './layout/Mould-Layout'
